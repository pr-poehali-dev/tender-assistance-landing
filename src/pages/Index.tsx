      ...
      <section className="py-24" id="cases">
        <div className="max-w-6xl mx-auto px-5">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { tag: "44-ФЗ", category: "Благоустройство", title: "Обрезка крон деревьев в охранной зоне ВЛ-0,4-10 кВ Центральных ЭС Крымэнерго", amount: "15 000 000 ₽", result: "Победа с первого участия", benefit: "Полное сопровождение под ключ", icon: "Trees" },
