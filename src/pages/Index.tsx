    ...
    <div className="font-sans bg-white min-h-screen text-gray-800">
      ...
      <section className="py-24" id="cases">
        <div className="max-w-6xl mx-auto px-5">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { tag: "223-ФЗ", category: "Благоустройство", title: "Обрезка крон деревьев в охранной зоне ВЛ-0,4-10 кВ Центральных ЭС Крымэнерго", amount: "15 000 000 ₽", result: "Победа с первого участия", benefit: "Полное сопровождение под ключ", icon: "Trees" },
              { tag: "44-ФЗ", category: "Трэвел-услуги", title: "Оказание услуг по обеспечению авиационными билетами для перевозки граждан – получателей государственной социальной помощи к месту лечения и обратно", amount: "18 500 000 ₽", result: "Победа с первого участия", benefit: "Полное сопровождение под ключ", icon: "Plane" },
      ...
      <section className="py-20 bg-gray-50" id="reviews">
        <div className="max-w-6xl mx-auto px-5">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { name: "Олег Куторкин", role: "Генеральный директор", company: "ООО «КомфортСтрой»", text: "Обратились после двух отклонённых заявок. Команда нашла ошибки за 2 часа, исправили — и выиграли на следующем тендере. Работаем уже год.", rating: 5 },
              { name: "Роман Рославцев", role: "Генеральный директор", company: "ООО «Альтера»", text: "Мы занимаемся предоставлением трэвел-услуг. 4 года назад моя компания с нуля зашла в тендеры — тогда мы и не знали, какой это мощный инструмент для бизнеса. С тех пор Ляйсан и её команда стали нам незаменимыми помощниками. Полностью налаженная работа!", rating: 5 },
              { name: "Наиль Исрафилов", role: "Учредитель", company: "ИП Исрафилов Н.З.", text: "Фиксированная цена, никаких сюрпризов. Я занимаюсь бизнесом, они — тендерами. Результат — многочисленные исполненные нами контракты на протяжении трёх лет. Работаем и дальше в том же ритме.", rating: 5 },
            ...
            <AnimatedSection>
              ...
              <div className="space-y-4">
                {[
                  ...
                  { icon: "MessageCircle", label: "WhatsApp", value: "Написать в WhatsApp", href: "https://wa.me/79174905751" },
